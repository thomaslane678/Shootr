...
const GAATeamStatsTheNumbersScreen = props => {
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <ShootrSupabaseDBAPIApi.FetchGAAWDLGET
                  TeamID={Constants['TeamID']}
                >
                  {({ loading, error, data, refetchGAAWDL }) => {
                  ...
                  {({
                    ...
                    return (
                      <SimpleStyleFlatList
                        ...
                        keyboardShouldPersistTaps={'never'}
                        listKey={
                          'Scroll View->Dashboard 2->Scores & Wides->Total Scored->View->Fetch 2->List'
                        }
                        nestedScrollEnabled={false}
                        numColumns={1}
                        onEndReachedThreshold={0.5}
          ...
          >
            ...
            >
              ...
              >
                ...
                {/* Fetch 2 */}
                <ShootrSupabaseDBAPIApi.FetchTeamSeasonStatsByActionGET
                  Action={'Opposition Restart Lost'}
                  TeamID={Constants['TeamID']}
                >
                  {({
                    loading,
...
export default withTheme(GAATeamStatsTheNumbersScreen);
