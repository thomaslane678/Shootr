...
const GAAMatchScreenBottomGoalScreen = props => {
    ...
    >
      ...
      >
        <ImageBackground
          ...
          {...GlobalStyles.ImageBackgroundStyles(theme)['Image Background']
            .props}
          source={imageSource(Images['Screenshot20240522At195631'])}
          style={StyleSheet.applyWidth(
            StyleSheet.compose(
              GlobalStyles.ImageBackgroundStyles(theme)['Image Background']
                .style,
              ...
              <Button
                ...
                onPress={() => {
                  ...
                  try {
                    ...
                    navigation.navigate('GAAMatchActionMainScreen');
      ...
      >
        ...
        <Button
          ...
          onPress={() => {
            try {
              navigation.navigate('GAAConfirmResultScreen');
            } catch (err) {
              console.error(err);
            }
          }}
      ...
      <View>
        ...
        <Button
          ...
          onPress={() => {
            try {
              navigation.navigate('GAALiveMatchStatsScreen');
            } catch (err) {
              console.error(err);
            }
          }}
...
export default withTheme(GAAMatchScreenBottomGoalScreen);
