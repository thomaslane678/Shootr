...
const RugbyAdvancedAnalyticsByMatchScreen = props => {
  ...
  React.useEffect(() => {
    const handler = async () => {
      try {
        ...
        const API1 = (
          await ShootrSupabaseDBAPIApi.matchStatsAnalyticsPlayerByMatchGET(
            Constants,
            {
  ...
  return (
    ...
    >
          ...
          <Button
            ...
            onPress={() => {
              const handler = async () => {
                try {
                  const API1 = (
                    await ShootrSupabaseDBAPIApi.matchActionCoordByMatchPlayerGET(
                      Constants,
                      {
      ...
      >
        ...
        >
          <View
            style={StyleSheet.applyWidth({ height: 650 }, dimensions.width)}
          >
            <WebView
...
`,
        ...
        <View>
          ...
          <Button
            ...
            onPress={() => {
              try {
                navigation.navigate('AdvancedAnalyticsFixtureSelectScreen');
                setGlobalVariableValue({
                  key: 'X1',
                  value: 1,
                });
        ...
        >
          ...
          >
            {({
              ...
              error,
              data,
              refetchPlayerMatchStatsByMatch$Player,
            }) => {
...
export default withTheme(RugbyAdvancedAnalyticsByMatchScreen);
