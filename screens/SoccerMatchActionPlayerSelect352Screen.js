...
const SoccerMatchActionPlayerSelect352Screen = props => {
              ...
              try {
                (
                  await shootrSupabaseDBAPIMatchStatsPostPOST.mutateAsync({
                    ...
                    MatchIDinputvalue5: Constants['MatchID'],
                    Oppositioninputvalue3: Constants['Opposition'],
                    PlayerIDinputvalue6: Constants['CCB UN'],
                    PlayerNameinputvalue7: Constants['CCB'],
                    TeamIDinputvalue4: Constants['TeamID'],
                    XValue: Constants['XAxis'],
                    YValue: Constants['YAxis'],
                  })
              ...
              try {
                (
                  await shootrSupabaseDBAPIMatchStatsPostPOST.mutateAsync({
                    ...
                    MatchIDinputvalue5: Constants['MatchID'],
                    Oppositioninputvalue3: Constants['Opposition'],
                    PlayerIDinputvalue6: Constants['RCF UN'],
...
export default withTheme(SoccerMatchActionPlayerSelect352Screen);
