...
const SoccerTeamListScreen = props => {
                          ...
                          onPress={() => {
                            try {
                              ...
                              if (Constants['Formation'] === 442) {
                                navigation.navigate('SoccerPickTeam442Screen');
                              } else {
                              }

                              if (Constants['Formation'] === 433) {
                                navigation.navigate('SoccerPickTeam433Screen');
                              } else {
                              }

                              if (Constants['Formation'] === 352) {
                                navigation.navigate('SoccerPickTeam352Screen');
                              } else {
                              }

                              if (Constants['Formation'] === 4231) {
                                navigation.navigate('SoccerPickTeam4231Screen');
                              } else {
                              }

                              if (Constants['Formation'] === 541) {
                                navigation.navigate('SoccerPickTeam541Screen');
                              } else {
                              }
                            } catch (err) {
                              console.error(err);
...
export default withTheme(SoccerTeamListScreen);
