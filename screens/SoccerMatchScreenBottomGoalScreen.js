...
const SoccerMatchScreenBottomGoalScreen = props => {
    ...
    >
      ...
      >
        ...
        >
          ...
          <View>
            ...
            <Stepper
              iconSize={24}
              onChange={newStepper3Value => {
                const stepperValue = newStepper3Value;
                try {
                  setStepperValue(stepperValue);
                  setGlobalVariableValue({
                    key: 'OppGoals',
                    value: newStepper3Value,
                  });
                } catch (err) {
                  console.error(err);
                }
      ...
      >
        <ImageBackground
          ...
          {...GlobalStyles.ImageBackgroundStyles(theme)['Image Background']
            .props}
          source={imageSource(Images['Screenshot20240512At152716'])}
          style={StyleSheet.applyWidth(
            StyleSheet.compose(
              GlobalStyles.ImageBackgroundStyles(theme)['Image Background']
                .style,
        ...
        >
          ...
          <View>
              ...
              <Button
                ...
                onPress={() => {
                  ...
                  try {
                    ...
                    navigation.navigate('SoccerMatchActionMainScreen');
            ...
            {/* View 10 */}
            <View style={StyleSheet.applyWidth({ top: 40 }, dimensions.width)}>
              {/* 1 */}
              <Button
                accessible={true}
                iconPosition={'left'}
      ...
      >
        ...
        <Button
          ...
          onPress={() => {
            try {
              navigation.navigate('SoccerConfirmResultScreen');
            } catch (err) {
              console.error(err);
            }
          }}
      ...
      <View>
        ...
        <Button
          ...
          onPress={() => {
            try {
              navigation.navigate('SoccerLiveMatchStatsScreen');
            } catch (err) {
              console.error(err);
            }
          }}
...
export default withTheme(SoccerMatchScreenBottomGoalScreen);
