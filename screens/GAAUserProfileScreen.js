...
const GAAUserProfileScreen = props => {
                  ...
                  {({
                    ...
                    return (
                      <SimpleStyleFlatList
                        ...
                        keyboardShouldPersistTaps={'never'}
                        listKey={
                          'Scroll View->Player Stats Dashboard->Scores & Wides->Total Scored->View->Fetch 2->List'
                        }
                        nestedScrollEnabled={false}
                        numColumns={1}
                        onEndReachedThreshold={0.5}
                  ...
                  {({
                    ...
                    return (
                      <SimpleStyleFlatList
                        ...
                        keyboardShouldPersistTaps={'never'}
                        listKey={
                          'Scroll View->Player Stats Dashboard->Restarts->Opp Restarts->View->Fetch 2->List'
                        }
                        nestedScrollEnabled={false}
                        numColumns={1}
                        onEndReachedThreshold={0.5}
...
export default withTheme(GAAUserProfileScreen);
