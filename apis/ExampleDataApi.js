...
export const foodCategoriesGET = async (
  Constants,
  _args,
  handlers,
  timeout
...
export const useFoodCategoriesGET = (
  ...
  return useQuery(
    ['FoodCategories', args],
    () => foodCategoriesGET(Constants, args, handlers, timeout),
    {
      refetchInterval,
      refetchOnWindowFocus,
      refetchOnMount,
...
export const foodItemsGET = async (Constants, _args, handlers, timeout) => {
...
export const useFoodItemsGET = (
  ...
  return useQuery(
    ['food_items', args],
    () => foodItemsGET(Constants, args, handlers, timeout),
    {
      refetchInterval,
      refetchOnWindowFocus,
      refetchOnMount,
...
export const foodSuggestionsGET = async (
  Constants,
  _args,
  handlers,
  timeout
...
export const useFoodSuggestionsGET = (
  ...
  return useQuery(
    ...
    () => foodSuggestionsGET(Constants, args, handlers, timeout),
    {
      refetchInterval,
      refetchOnWindowFocus,
      refetchOnMount,
...
export const grabDataPointsGET = async (
  Constants,
  _args,
  handlers,
  timeout
...
export const useGrabDataPointsGET = (
  ...
  return useQuery(
    ['users', args],
    () => grabDataPointsGET(Constants, args, handlers, timeout),
    {
      refetchInterval,
      refetchOnWindowFocus,
      refetchOnMount,
...
export const languagesGET = async (Constants, _args, handlers, timeout) => {
...
export const useLanguagesGET = (
  ...
  return useQuery(
    ['languages', args],
    () => languagesGET(Constants, args, handlers, timeout),
    {
      refetchInterval,
      refetchOnWindowFocus,
      refetchOnMount,
...
export const notificationsGET = async (Constants, _args, handlers, timeout) => {
...
export const useNotificationsGET = (
  ...
  return useQuery(
    ['notifications', args],
    () => notificationsGET(Constants, args, handlers, timeout),
    {
      refetchInterval,
      refetchOnWindowFocus,
      refetchOnMount,
...
export const restaurantsGET = async (Constants, _args, handlers, timeout) => {
...
export const useRestaurantsGET = (
  ...
  return useQuery(
    ['restaurants', args],
    () => restaurantsGET(Constants, args, handlers, timeout),
    {
      refetchInterval,
      refetchOnWindowFocus,
      refetchOnMount,
...
export const usersGET = async (Constants, { count }, handlers, timeout) => {
  const paramsDict = {};
  if (count !== undefined) {
